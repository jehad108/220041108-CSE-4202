...
int main()
{
    ...
    while (key)
    {
        ...
        if (option == 1)
        {
            ...
            while (getline(myfile, temp.spellid, ',') &&
        ...
        else if (option == 4)
        {
            ...
            for (int i = 0; i < information.size(); i++)
            {
                if (information[i].spellid == search)
                {
                    cout << "Incantation:" << information[i].Incantation << "\nSpell Name:" << information[i].Spell_Name << "\nEffect:" << information[i].Effect << "\nLight:" << information[i].light << endl;
                }
            }
        ...
        else if (option == 5)
        {
            ...
            for (int i = 0; i < information.size(); i++)
            {
                if (information[i].spellid == entry)
                {
                    if (part == 1)
                    {
                        cin >> information[i].Incantation;
                    }
                    else if (part == 2)
                    {
                        cin >> information[i].Spell_Name;
                    }
                    else if (part == 3)
                    {
                        cin >> information[i].Effect;
                    }
                    else
                    {
                        cin >> information[i].light;
                    }
                }
            }
